...
public class LightScript : MonoBehaviour
{
    ...
    /*void SpawnLightAtMousePosition()
    {
        ...
        void SpawnLightAtMousePosition()
         {
        Vector2 mousePosition = Camera.main.ScreenToWorldPoint(Input.mousePosition);
        if (mousePosition.y - playerTransform.position.y > 2)
        {
            mousePosition = new Vector2(mousePosition.x, playerTransform.position.y + 2);
        }
        else if(playerTransform.position.y-mousePosition.y>2)
        {
            mousePosition = new Vector2(mousePosition.x, playerTransform.position.y -2);
        }
